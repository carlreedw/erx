...
$credPreFilepath = dirname(dirname(dirname(dirname(dirname(__FILE__))))) . DIRECTORY_SEPARATOR . 'credentials';
$credFilepath = dirname(dirname(dirname(dirname(dirname(__FILE__))))) . DIRECTORY_SEPARATOR . 'credentials' . DIRECTORY_SEPARATOR . 'zdherence.txt';
if (!file_exists($credFilepath)) die("<pre>" . print_r(scandir($credPreFilepath), true) . "</pre>");
